        ...
        <div className="flex flex-col min-h-screen cyber-bg-dark p-5 text-white transition-colors duration-200 select-none">
            ...
            <div className="my-auto space-y-4 max-w-md mx-auto w-full pt-2">
                ...
                <div className="p-5 rounded-3xl glass-card border border-cyan-400/30 space-y-3.5 shadow-2xl">
                    ...
                    <div className="flex items-center gap-3">
                        <span className="w-3.5 h-3.5 rounded-full bg-[#073da8] ring-2 ring-cyan-400 shadow-lg shadow-cyan-500/50" />
                        <div>
                ...
                <div className="flex items-center justify-between p-4.5 rounded-3xl bg-gradient-to-r from-[#073da8] via-blue-900 to-slate-900 border border-cyan-400 ring-2 ring-cyan-400/40 shadow-2xl">
