    ...
    return (
        <div className="p-4.5 rounded-3xl glass-panel shadow-2xl space-y-3.5 border border-slate-200 dark:border-cyan-400/30">
            ...
            <div className="flex items-center justify-between pb-2.5 border-b border-slate-200 dark:border-cyan-500/20">
                ...
                <div className="w-10 h-10 rounded-2xl bg-emerald-50 dark:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 flex items-center justify-center shadow-md border border-emerald-200 dark:border-emerald-500/40">
                ...
                <div className="flex items-center gap-3.5">
                    <div className="relative">
                        <img
                            src={driver.avatar}
                            alt={driver.name}
                            className="w-14 h-14 rounded-2xl object-cover ring-2 ring-blue-400/50 dark:ring-cyan-400/50 shadow-xl"
                        />
                    ...
                    <div>
                        ...
                        <span className="inline-block mt-1 px-2.5 py-0.5 rounded-lg bg-slate-100 dark:bg-slate-900 text-[#0221bf] dark:text-cyan-400 text-[11px] font-mono font-extrabold tracking-widest border border-slate-200 dark:border-cyan-500/30 shadow-sm">
